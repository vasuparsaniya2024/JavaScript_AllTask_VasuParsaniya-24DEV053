        ...
        tableadd.innerHTML = `
                <tr>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofboardssc%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpassingyearstyle"><%= errorobject.passingyearssc%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpercentagestyle"><%= errorobject.percentagessc%></span>
                    </td>
                </tr>`;
        ...
        tableadd.innerHTML = `
                <tr>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofboardhsc%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpassingyearstyle"><%= errorobject.passingyearhsc%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpercentagestyle"><%= errorobject.percentagehsc%></span>
                    </td>
                </tr>`;
        ...
        tableadd.innerHTML = `
                <tr>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofcoursebachelor%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofuniversitybachelor%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpassingyearstyle"><%= errorobject.passingyearbachelor%></span>
                    </td>
                    <td>
        ...
        tableadd.innerHTML = `
                <tr>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofcoursemaster%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle"><%= errorobject.nameofuniversitymaster%></span>
                    </td>
                    <td>
                        ...
                        <span class="reqerroreducationdetailsstyle errorpassingyearstyle"><%= errorobject.passingyearmaster%></span>
                    </td>
                    <td>
...
function addexperience() {
    ...
    <td>
        ...
        <input type="text" id="companyname${experiencecomponent_id}" name="companyname" class="reqerrorexperience companynameerror">
    ...
    <td>
        ...
        <input type="text" id="companydesignation${experiencecomponent_id}" name="companydesignation" class="reqerrorexperience companydesignationerror">
    ...
    <td>
        ...
        <input type="text" id="companyfrom${experiencecomponent_id}" name="companyfrom" class="reqerrorexperience companydateerror">
        <span class="reqerrorexperiencestyle companydateerrorstyle"></span>
    </td>
    <td>
        <label for="companyto${experiencecomponent_id}">To</label>
        <input type="text" id="companyto${experiencecomponent_id}" name="companyto" class="reqerrorexperience companydateerror">
        <span class="reqerrorexperiencestyle companydateerrorstyle"></span>
    </td>
    <td>
...
function addreference() {
    ...
    <td>
        ...
        <input type="text" id="referencename${referencecomponent_id}" name="referencename" class="reqerrorreference referencenameerror">
        <span class="reqerrorreferencestyle"></span>
    </td>
    <td>
        <label for="referencenumber${referencecomponent_id}">Contact Number</label>
        <input type="text" id="referencenumber${referencecomponent_id}" name="referencenumber" class="reqerrorreference referencenumbererror">
    ...
    <td>
        ...
        <input type="text" id="referencerelation${referencecomponent_id}" name="referencerelation" class="reqerrorreference">
        <span class="reqerrorreferencestyle"></span>
    </td>
    <td>
