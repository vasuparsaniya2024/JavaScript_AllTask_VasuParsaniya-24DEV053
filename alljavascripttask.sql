...
-- --------------------------registration, login
CREATE TABLE alljavascripttask.usersregistration
select * from registration.usersregistration;

CREATE TABLE alljavascripttask.linkactivationcodes
select * from registration.linkactivationcodes;
