...
router.get('/listtask',(req,res)=>{
    let exerciseJsonObject = {
        ...
        "Student List","Student List With Paggination","Student Attandance Report"],
        ...
        "/task9_studentDetails","/task10_studentDetailswithpaggination","/task11_studentAttandance"]
    }
